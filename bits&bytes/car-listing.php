...
<title>Bits & Bytes Technology Data Center | Listado de componentes</title>
<!--Bootstrap -->
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Articulos recientemente</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/Componentes/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">Q<?php echo htmlentities($result->PricePerDay);?> Por unidad</p>
                </div>
              </li>
              <?php }} ?>
